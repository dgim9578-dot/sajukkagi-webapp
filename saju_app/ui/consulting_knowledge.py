...
- 고객 질문의 **핵심 단어·상황(누구·무엇·언제·왜)** 에 먼저 답한 뒤 사주를 연결합니다.
- 질문과 다른 주제(예: 연애 질문에 재물만 설명)로 답하지 않습니다.
- 일반론·반복 문장·질문과 무관한 사주 설명은 피합니다.
...
def normalize_topic(topic: str) -> str:
    ...
    if any(
        ...
        return "sinsal"
    if any(k in text for k in ("오늘", "이번달", "다음달", "신년", "월운", "일운", "타이밍")):
        return "general"
    return "general"
